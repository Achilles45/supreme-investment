        ...
        <div class="dashboard__wrapper">
           ...
           <div class="dashboard__right">
             ...
             <hr>
              ...
              <hr>
              <div></div>
              <p>After making payment, please upload your proof of payment using the upload proof section of your dashboard send a whatsapp(only) message to to customer care using the live chat so your payment can be immediately approved.</p>
              </div>
            <!--End of Dashboard
            =========================-->
              <br>
